///
/// Graphics via SDL_Renderer: renderer lifecycle, general drawing, surfaces,
/// and the text atlas. Geometry lives in graphics_sdl_geometry.cpp and CPU
/// pixel access in graphics_sdl_pixels.cpp.
///
