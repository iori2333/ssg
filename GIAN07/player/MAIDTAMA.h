...
inline constexpr auto TID_HOMING_MAIN = 0x02; // ホーミング・メインショットのＩＤ
inline constexpr auto TID_HOMING_SUB = 0x03; // ホーミング・サブショットのＩＤ
inline constexpr auto TID_LASER_MAIN = 0x04; // レーザー・メインショット？？のＩＤ
...
inline constexpr auto TDM_HOMING_MAIN = 6; // ホーミング・メインショットのダメージ
