...
ECL_HEAD:
  ...
  case EclOp::CALL: {
    ...
    e.call_addr = e.cmd + EclCmdLength(EclOp::CALL);
    e.cmd = c.target;
    goto ECL_HEAD;
  }
  case EclOp::RET:
  ...
  case EclOp::ACCXYA:
    e.cmd += EclCmdLength(EclOp::ACCXYA);
  ...
  case EclOp::HLASER: {
    ...
    HLaserSet(&HInfo);
    e.cmd += EclCmdLength(EclOp::HLASER);
  ...
  case EclOp::STG3EFC:
    ...
    e.cmd += EclCmdLength(EclOp::STG3EFC);
