...
template <ENUMFLAGS T>
constexpr inline std::underlying_type_t<T> operator~(const T &v) noexcept {
  return ~std::to_underlying(v);
}

template <ENUMFLAGS T>
constexpr inline T operator&(const T &a, const T &b) noexcept {
...
template <ENUMFLAGS T>
constexpr inline T &operator|=(T &a, const T &b) noexcept {
...
constexpr inline T &operator&=(T &a,
                               const std::underlying_type_t<T> &b) noexcept {
...
template <ENUMFLAGS T>
constexpr void EnumFlagSet(T &self, T flag, std::underlying_type_t<T> val) {
