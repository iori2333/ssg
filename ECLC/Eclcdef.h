...
CONV_INFO CMD_BUF[ECL_CMDMAX] = {
    ...
    {"TSPDR", ECL_TSPDR, DT_S1, DT_S1,
     DT_END},                          // v,a (v はフラグ変化をしないものとする)
    ...
    {"SINL", ECL_SINL, DT_U1, DT_U1,
     DT_END}, // Reg0,Reg1  : Reg0 = Reg0*sin[Reg1%256]
    {"COSL", ECL_COSL, DT_U1, DT_U1,
     DT_END}, // Reg0,Reg1  : Reg0 = Reg0*cos[Reg1%256]
    {"MOD", ECL_MOD, DT_U1, DT_U4, DT_END}, // Reg0,Const : Reg0 = Reg0%(Const)
    {"RND", ECL_RND, DT_U1, DT_END},        // Reg0       : Reg0 = rnd()
    {"CMPR", ECL_CMPR, DT_U1, DT_U1,
     DT_END}, // Reg0,Reg1     : Signed Compare Reg0,Reg1
    {"CMPC", ECL_CMPC, DT_U1, DT_S4,
     DT_END},                        // Reg,Const(32) : Signed Compare Reg,Const
